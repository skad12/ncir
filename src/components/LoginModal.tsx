          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={(v) => setSelectedRole(v)} value={selectedRole}>
              ...
              <SelectContent className="bg-white border-gray-200">
                <SelectItem value="super-admin" className="hover:bg-gray-200">Super Admin (NCIR/Algorizmi)</SelectItem>
                <SelectItem value="contributor" className="hover:bg-gray-200">Contributor (Hospital/Clinic)</SelectItem>
                <SelectItem value="annotator" className="hover:bg-gray-200">Annotator (Medical Expert)</SelectItem>
                <SelectItem value="researcher" className="hover:bg-gray-200">Researcher (Academic/Industry)</SelectItem>
                <SelectItem value="ethicsofficer" className="hover:bg-gray-200">Ethics Officer (Audit)</SelectItem>
              </SelectContent>
            </Select>
          </div>
